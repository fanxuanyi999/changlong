...
const days=[
 ...
 {title:'从小火车开始，把一天玩舒服',intro:'上午留给最想看的动物，中午认真坐下吃饭，下午走慢一点。晚上的大马戏值得我们提前回酒店休息。',stops:[
  ...
  {time:'14:30—15:30 · 条件项目',title:'缆车，放在这时候坐',icon:'route',text:'走到熊猫乐园站附近后，先看线路与排队情况。若能环园回到本站，可作为一段坐着看风景的休息。',photos:['cable'],hint:'仍停运、雷雨或预计排队超过30分钟，就跳过并提前回酒店。15:30停止新增项目。',sources:['cable1','cable2'],more:'A｜确认环园线路开放，乘坐暂按约30分钟预留，另加排队。\nB｜仅部分线路开放：确认上下车站与回酒店出口顺路再坐，不默认能到北门。\nC｜停运：在开放熊猫或考拉区域慢看，或者直接回酒店。'},
